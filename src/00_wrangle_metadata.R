...
setwd(wd)
dir.create("out/merged_normal_bams/", showWarnings = FALSE)
dir.create("out/nanoseq/", showWarnings = FALSE)
...
sample_sheet_nanoseq <-
  ...
  dplyr::transmute(
    ...
    n_bam = file.path(wd, "out/merged_normal_bams", 
